...
// getUserDataSecretName gets the UserData from the machine and exposes it as a secret
...
func (m *MachineManager) SetNodeProviderID(ctx context.Context, bmhID, providerID string, clientFactory ClientGetter) error {
	...
	nodes, err := corev1Remote.Nodes().List(context.TODO(), metav1.ListOptions{
	...
	for _, node := range nodes.Items {
		...
		_, err = corev1Remote.Nodes().Update(context.TODO(), &node, metav1.UpdateOptions{})
		if err != nil {
