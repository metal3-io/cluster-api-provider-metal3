...
//
//	mockgen -destination=./baremetal/mocks/zz_generated.metal3machinetemplate_manager.go -source=./baremetal/metal3machinetemplate_manager.go -package=baremetal_mocks -copyright_file=./hack/boilerplate/boilerplate.generatego.txt TemplateManagerInterface
//
...
func (mr *MockTemplateManagerInterfaceMockRecorder) UpdateAutomatedCleaningMode(arg0 any) *gomock.Call {
