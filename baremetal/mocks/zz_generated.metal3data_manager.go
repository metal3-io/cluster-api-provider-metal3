...
//
//	mockgen -destination=./baremetal/mocks/zz_generated.metal3data_manager.go -source=./baremetal/metal3data_manager.go -package=baremetal_mocks -copyright_file=./hack/boilerplate/boilerplate.generatego.txt DataManagerInterface
//
...
func (mr *MockDataManagerInterfaceMockRecorder) Reconcile(ctx any) *gomock.Call {
...
func (mr *MockDataManagerInterfaceMockRecorder) ReleaseLeases(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
