...
//
//	mockgen -destination=./baremetal/mocks/zz_generated.metal3cluster_manager.go -source=./baremetal/metal3cluster_manager.go -package=baremetal_mocks -copyright_file=./hack/boilerplate/boilerplate.generatego.txt ClusterManagerInterface
//
...
func (mr *MockClusterManagerInterfaceMockRecorder) CountDescendants(arg0 any) *gomock.Call {
...
func (mr *MockClusterManagerInterfaceMockRecorder) Create(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
