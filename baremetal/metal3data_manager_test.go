...
var _ = Describe("Metal3Data manager", func() {
	DescribeTable("Test Finalizers",
		func(data *infrav1beta1.Metal3Data) {
		...
		Entry("No finalizers", &infrav1beta1.Metal3Data{}),
		Entry("Additional Finalizers", &infrav1beta1.Metal3Data{
	...
	type testCaseReconcile struct {
		...
		m3dt             *infrav1beta1.Metal3DataTemplate
	...
	DescribeTable("Test CreateSecret",
		...
		Entry("Clear Error", testCaseReconcile{
			m3d: &infrav1beta1.Metal3Data{
				Spec: infrav1beta1.Metal3DataSpec{},
				Status: infrav1beta1.Metal3DataStatus{
	...
	type testCaseCreateSecrets struct {
		...
		m3dt                *infrav1beta1.Metal3DataTemplate
		m3m                 *infrav1beta1.Metal3Machine
		dataClaim           *infrav1beta1.Metal3DataClaim
	...
	DescribeTable("Test CreateSecret",
		...
		Entry("No Metal3Machine in owner refs", testCaseCreateSecrets{
			...
			dataClaim: &infrav1beta1.Metal3DataClaim{
				ObjectMeta: testObjectMeta,
				Spec:       infrav1beta1.Metal3DataClaimSpec{},
			},
			expectError: true,
		}),
		...
		Entry("secrets exist", testCaseCreateSecrets{
			...
			m3dt: &infrav1beta1.Metal3DataTemplate{
				ObjectMeta: testObjectMeta,
				Spec: infrav1beta1.Metal3DataTemplateSpec{
					MetaData: &infrav1beta1.MetaData{
						Strings: []infrav1beta1.MetaDataString{
							{
								Key:   "String-1",
								Value: "String-1",
							},
					...
					NetworkData: &infrav1beta1.NetworkData{
						Links: infrav1beta1.NetworkDataLink{
							Ethernets: []infrav1beta1.NetworkDataLinkEthernet{
								{
									Type: "phy",
									Id:   "eth0",
									MTU:  1500,
									MACAddress: &infrav1beta1.NetworkLinkEthernetMac{
	...
	type testCaseGetAddressesFromPool struct {
		m3dtSpec      infrav1beta1.Metal3DataTemplateSpec
		ipClaims      []string
		expectError   bool
		expectRequeue bool
	}
	...
	DescribeTable("Test GetAddressesFromPool",
		...
		Entry("Metadata ok", testCaseGetAddressesFromPool{
			m3dtSpec: infrav1beta1.Metal3DataTemplateSpec{
				MetaData: &infrav1beta1.MetaData{
					IPAddressesFromPool: []infrav1beta1.FromPool{
						{
							Key:  "Address-1",
							Name: "abcd-1",
						},
					},
					PrefixesFromPool: []infrav1beta1.FromPool{
						{
							Key:  "Prefix-1",
							Name: "abcd-2",
						},
					},
					GatewaysFromPool: []infrav1beta1.FromPool{
						{
							Key:  "Gateway-1",
							Name: "abcd-3",
						},
				...
				NetworkData: &infrav1beta1.NetworkData{
					Networks: infrav1beta1.NetworkDataNetwork{
						IPv4: []infrav1beta1.NetworkDataIPv4{
							{
								IPAddressFromIPPool: "abcd-4",
								Routes: []infrav1beta1.NetworkDataRoutev4{
									{
										Gateway: infrav1beta1.NetworkGatewayv4{
						...
						IPv6: []infrav1beta1.NetworkDataIPv6{
							{
								IPAddressFromIPPool: "abcd-6",
								Routes: []infrav1beta1.NetworkDataRoutev6{
									{
										Gateway: infrav1beta1.NetworkGatewayv6{
						...
						IPv4DHCP: []infrav1beta1.NetworkDataIPv4DHCP{
							{
								Routes: []infrav1beta1.NetworkDataRoutev4{
									{
										Gateway: infrav1beta1.NetworkGatewayv4{
						...
						IPv6DHCP: []infrav1beta1.NetworkDataIPv6DHCP{
							{
								Routes: []infrav1beta1.NetworkDataRoutev6{
									{
										Gateway: infrav1beta1.NetworkGatewayv6{
						...
						IPv6SLAAC: []infrav1beta1.NetworkDataIPv6DHCP{
							{
								Routes: []infrav1beta1.NetworkDataRoutev6{
									{
										Gateway: infrav1beta1.NetworkGatewayv6{
			...
			m3dt: &infrav1beta1.Metal3DataTemplate{
				Spec: infrav1beta1.Metal3DataTemplateSpec{
					NetworkData: &infrav1beta1.NetworkData{
									...
									Routes: []infrav1beta1.NetworkDataRoutev4{
										{
											...
											Services: infrav1beta1.NetworkDataServicev4{
						...
						Services: infrav1beta1.NetworkDataService{
	...
	DescribeTable("Test renderNetworkLinks",
		...
		Entry("Bond, MAC from string", testCaseRenderNetworkLinks{
			links: infrav1beta1.NetworkDataLink{
				Bonds: []infrav1beta1.NetworkDataLinkBond{
					{
						BondMode: "802.3ad",
						Id:       "bond0",
						MTU:      1500,
		...
		Entry("Vlan, MAC from string", testCaseRenderNetworkLinks{
			links: infrav1beta1.NetworkDataLink{
				Vlans: []infrav1beta1.NetworkDataLinkVlan{
					{
						VlanID: 2222,
						Id:     "bond0",
						MTU:    1500,
						...
						Routes: []infrav1beta1.NetworkDataRoutev6{
							{
								...
								Services: infrav1beta1.NetworkDataServicev6{
	...
	It("Test getRoutesv4", func() {
		netRoutes := []infrav1beta1.NetworkDataRoutev4{
			{
				Network: "192.168.0.0",
				Prefix:  24,
				Gateway: infrav1beta1.NetworkGatewayv4{
	...
	It("Test getRoutesv6", func() {
		netRoutes := []infrav1beta1.NetworkDataRoutev6{
			{
				Network: "2001::0",
				Prefix:  96,
				Gateway: infrav1beta1.NetworkGatewayv6{
	...
	type testCaseGetLinkMacAddress struct {
		mac         *infrav1beta1.NetworkLinkEthernetMac
		bmh         *bmo.BareMetalHost
		expectError bool
		expectedMAC string
	}
			...
			m3dt: &infrav1beta1.Metal3DataTemplate{
				...
				Spec: infrav1beta1.Metal3DataTemplateSpec{
					MetaData: &infrav1beta1.MetaData{
						...
						ObjectNames: []infrav1beta1.MetaDataObjectName{
							{
								Key:    "ObjectName-1",
								Object: "machine",
							},
						...
						Namespaces: []infrav1beta1.MetaDataNamespace{
							{
								Key: "Namespace-1",
							},
						},
						Indexes: []infrav1beta1.MetaDataIndex{
							{
								Key:    "Index-1",
								Offset: 10,
								Step:   2,
						...
						FromHostInterfaces: []infrav1beta1.MetaDataHostInterface{
							{
								Key:       "Mac-1",
								Interface: "eth1",
							},
						},
						FromLabels: []infrav1beta1.MetaDataFromLabel{
							{
								Key:    "Label-1",
								Object: "metal3machine",
								Label:  "Doesnotexist",
						...
						FromAnnotations: []infrav1beta1.MetaDataFromAnnotation{
							{
								Key:        "Annotation-1",
								Object:     "metal3machine",
	...
	type testCaseGetM3Machine struct {
		Machine       *infrav1beta1.Metal3Machine
		Data          *infrav1beta1.Metal3Data
		DataTemplate  *infrav1beta1.Metal3DataTemplate
		DataClaim     *infrav1beta1.Metal3DataClaim
		ExpectError   bool
		ExpectRequeue bool
		ExpectEmpty   bool
