...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*v1alpha5.Metal3ClusterStatus)(nil), (*Metal3ClusterStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha4_Metal3ClusterList_To_v1alpha5_Metal3ClusterList(in *Metal3ClusterList, out *v1alpha5.Metal3ClusterList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]v1alpha5.Metal3Cluster, len(*in))
		for i := range *in {
			if err := Convert_v1alpha4_Metal3Cluster_To_v1alpha5_Metal3Cluster(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha5_Metal3ClusterList_To_v1alpha4_Metal3ClusterList(in *v1alpha5.Metal3ClusterList, out *Metal3ClusterList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]Metal3Cluster, len(*in))
		for i := range *in {
			if err := Convert_v1alpha5_Metal3Cluster_To_v1alpha4_Metal3Cluster(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
