...
func autoConvert_v1alpha4_Metal3ClusterList_To_v1beta1_Metal3ClusterList(in *Metal3ClusterList, out *v1beta1.Metal3ClusterList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]v1beta1.Metal3Cluster, len(*in))
		for i := range *in {
			if err := Convert_v1alpha4_Metal3Cluster_To_v1beta1_Metal3Cluster(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1beta1_Metal3ClusterList_To_v1alpha4_Metal3ClusterList(in *v1beta1.Metal3ClusterList, out *Metal3ClusterList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]Metal3Cluster, len(*in))
		for i := range *in {
			if err := Convert_v1beta1_Metal3Cluster_To_v1alpha4_Metal3Cluster(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha4_Metal3MachineList_To_v1beta1_Metal3MachineList(in *Metal3MachineList, out *v1beta1.Metal3MachineList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]v1beta1.Metal3Machine, len(*in))
		for i := range *in {
			if err := Convert_v1alpha4_Metal3Machine_To_v1beta1_Metal3Machine(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1beta1_Metal3MachineList_To_v1alpha4_Metal3MachineList(in *v1beta1.Metal3MachineList, out *Metal3MachineList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]Metal3Machine, len(*in))
		for i := range *in {
			if err := Convert_v1beta1_Metal3Machine_To_v1alpha4_Metal3Machine(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
