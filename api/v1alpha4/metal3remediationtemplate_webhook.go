...
// +kubebuilder:webhook:path=/mutate-infrastructure-cluster-x-k8s-io-v1alpha4-metal3remediationtemplate,mutating=true,failurePolicy=fail,groups=infrastructure.cluster.x-k8s.io,resources=metal3remediationtemplates,verbs=create;update,versions=v1alpha4,name=metal3remediationtemplate.kb.io,matchPolicy=Equivalent,sideEffects=None,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-infrastructure-cluster-x-k8s-io-v1alpha4-metal3remediationtemplate,mutating=false,failurePolicy=fail,groups=infrastructure.cluster.x-k8s.io,resources=metal3remediationtemplates,versions=v1alpha4,name=metal3remediationtemplate.kb.io,matchPolicy=Equivalent,sideEffects=None,admissionReviewVersions=v1beta1
