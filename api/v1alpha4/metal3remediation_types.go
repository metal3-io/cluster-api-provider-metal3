...
// MachineRemediationStrategy describes how to remediate machines
...
// +kubebuilder:printcolumn:name="Last Remediated",type=string,JSONPath=".status.lastRemediated",description="Timestap of the last remediation attempt"
