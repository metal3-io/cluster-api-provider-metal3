...
func Convert_v1alpha4_Image_To_v1alpha2_Image(in *v1alpha4.Image, out *Image, s apiconversion.Scope) error {
	if err := autoConvert_v1alpha4_Image_To_v1alpha2_Image(in, out, s); err != nil {
		return err
	}
