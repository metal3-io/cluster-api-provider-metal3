...
func autoConvert_v1alpha2_Metal3MachineTemplateList_To_v1alpha3_Metal3MachineTemplateList(in *Metal3MachineTemplateList, out *v1alpha3.Metal3MachineTemplateList, s conversion.Scope) error {
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]v1alpha3.Metal3MachineTemplate, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_Metal3MachineTemplate_To_v1alpha3_Metal3MachineTemplate(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha3_Metal3MachineTemplateList_To_v1alpha2_Metal3MachineTemplateList(in *v1alpha3.Metal3MachineTemplateList, out *Metal3MachineTemplateList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]Metal3MachineTemplate, len(*in))
		for i := range *in {
			if err := Convert_v1alpha3_Metal3MachineTemplate_To_v1alpha2_Metal3MachineTemplate(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
