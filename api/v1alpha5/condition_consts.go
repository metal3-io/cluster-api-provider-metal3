...
const (
	// BaremetalInfrastructureReadyCondition reports the current status of cluster infrastructure. At the moment this is cosmetic since Metal3Cluster does not contain any infra setup steps.
