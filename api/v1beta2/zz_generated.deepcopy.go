...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailureDomainDataTemplate) DeepCopyInto(out *FailureDomainDataTemplate) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailureDomainDataTemplate.
func (in *FailureDomainDataTemplate) DeepCopy() *FailureDomainDataTemplate {
	if in == nil {
		return nil
	}
	out := new(FailureDomainDataTemplate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetaDataHostInterface) DeepCopyInto(out *MetaDataHostInterface) {
	*out = *in
	if in.FromBootMAC != nil {
		in, out := &in.FromBootMAC, &out.FromBootMAC
		*out = new(bool)
		**out = **in
	}
}
...
func (in *Metal3MachineTemplateSpec) DeepCopyInto(out *Metal3MachineTemplateSpec) {
	*out = *in
	in.Template.DeepCopyInto(&out.Template)
	if in.NodeReuse != nil {
		in, out := &in.NodeReuse, &out.NodeReuse
		*out = new(bool)
		**out = **in
	}
	if in.FailureDomainDataTemplates != nil {
		in, out := &in.FailureDomainDataTemplates, &out.FailureDomainDataTemplates
		*out = make([]FailureDomainDataTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NetworkDataIPv4) DeepCopyInto(out *NetworkDataIPv4) {
	*out = *in
	...
	out.FromPoolAnnotation = in.FromPoolAnnotation
	if in.Routes != nil {
...
func (in *NetworkLinkEthernetMac) DeepCopyInto(out *NetworkLinkEthernetMac) {
	*out = *in
	out.FromAnnotation = in.FromAnnotation
}
