...
const (
	...
	// WaitingForClusterInfrastructureReasonReadyV1Beta2Reason used when waiting for cluster
	// infrastructure to be ready before proceeding.
	WaitingForClusterInfrastructureReasonReadyV1Beta2Reason = clusterv1beta1.WaitingForClusterInfrastructureReadyV1Beta2Reason
	...
	// KubernetesNodeReadyV1Beta2Condition documents the transition of a Metal3Machine into a Kubernetes Node.
	KubernetesNodeReadyV1Beta2Condition = "KubernetesNodeReady"
