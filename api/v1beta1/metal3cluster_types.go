...
const (
	// Metal3ClusterReadyConditionV1Beta2Condition reports the current status of
	// cluster infrastructure. At the moment this is cosmetic since
	// Metal3Cluster does not contain any infra setup steps.
	Metal3ClusterReadyConditionV1Beta2Condition = clusterv1beta1.ReadyV1Beta2Condition
	// Metal3ClusterReadyConditionV1Beta2Reason surfaces when the cluster modules for a Metal3Cluster are ready.
	Metal3ClusterReadyConditionV1Beta2Reason = clusterv1beta1.ReadyV1Beta2Reason
	// Metal3ClusterNotReadyConditionV1Beta2Reason surfaces when the Metal3Cluster readiness criteria is not met.
	ControlPlaneEndpointFailedReasonV1Beta2Reason = "ControlPlaneEndpointFailed"
