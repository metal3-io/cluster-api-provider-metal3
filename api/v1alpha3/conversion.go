...
func (src *Metal3Cluster) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1alpha3_Metal3Cluster_To_v1alpha5_Metal3Cluster(src, dst, nil)
}

func (dst *Metal3Cluster) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*v1alpha5.Metal3Cluster)
	return Convert_v1alpha5_Metal3Cluster_To_v1alpha3_Metal3Cluster(src, dst, nil)
}

func (src *Metal3ClusterList) ConvertTo(dstRaw conversion.Hub) error {
	dst := dstRaw.(*v1alpha5.Metal3ClusterList)
	return Convert_v1alpha3_Metal3ClusterList_To_v1alpha5_Metal3ClusterList(src, dst, nil)
}

func (dst *Metal3ClusterList) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*v1alpha5.Metal3ClusterList)
	return Convert_v1alpha5_Metal3ClusterList_To_v1alpha3_Metal3ClusterList(src, dst, nil)
}

func (src *Metal3Machine) ConvertTo(dstRaw conversion.Hub) error {
	dst := dstRaw.(*v1alpha5.Metal3Machine)
	if err := Convert_v1alpha3_Metal3Machine_To_v1alpha5_Metal3Machine(src, dst, nil); err != nil {
		return err
	}
...
func (dst *Metal3Machine) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha5_Metal3Machine_To_v1alpha3_Metal3Machine(src, dst, nil); err != nil {
		return err
	}
...
func (src *Metal3MachineList) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1alpha3_Metal3MachineList_To_v1alpha5_Metal3MachineList(src, dst, nil)
}

func (dst *Metal3MachineList) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*v1alpha5.Metal3MachineList)
	return Convert_v1alpha5_Metal3MachineList_To_v1alpha3_Metal3MachineList(src, dst, nil)
}

func (src *Metal3MachineTemplate) ConvertTo(dstRaw conversion.Hub) error {
	dst := dstRaw.(*v1alpha5.Metal3MachineTemplate)
	if err := Convert_v1alpha3_Metal3MachineTemplate_To_v1alpha5_Metal3MachineTemplate(src, dst, nil); err != nil {
		return err
	}
...
func (dst *Metal3MachineTemplate) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha5_Metal3MachineTemplate_To_v1alpha3_Metal3MachineTemplate(src, dst, nil); err != nil {
		return err
	}
...
func (src *Metal3MachineTemplateList) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1alpha3_Metal3MachineTemplateList_To_v1alpha5_Metal3MachineTemplateList(src, dst, nil)
}

func (dst *Metal3MachineTemplateList) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*v1alpha5.Metal3MachineTemplateList)
	return Convert_v1alpha5_Metal3MachineTemplateList_To_v1alpha3_Metal3MachineTemplateList(src, dst, nil)
}

func Convert_v1alpha5_Metal3MachineSpec_To_v1alpha3_Metal3MachineSpec(in *v1alpha5.Metal3MachineSpec, out *Metal3MachineSpec, s apiconversion.Scope) error {
	if err := autoConvert_v1alpha5_Metal3MachineSpec_To_v1alpha3_Metal3MachineSpec(in, out, s); err != nil {
		return err
	}
...
func Convert_v1alpha5_Metal3MachineStatus_To_v1alpha3_Metal3MachineStatus(in *v1alpha5.Metal3MachineStatus, out *Metal3MachineStatus, s apiconversion.Scope) error {
	if err := autoConvert_v1alpha5_Metal3MachineStatus_To_v1alpha3_Metal3MachineStatus(in, out, s); err != nil {
		return err
	}
...
func Convert_v1alpha5_Image_To_v1alpha3_Image(in *v1alpha5.Image, out *Image, s apiconversion.Scope) error {
	if err := autoConvert_v1alpha5_Image_To_v1alpha3_Image(in, out, s); err != nil {
		return err
	}
...
func Convert_v1alpha5_Metal3MachineTemplateSpec_To_v1alpha3_Metal3MachineTemplateSpec(in *v1alpha5.Metal3MachineTemplateSpec, out *Metal3MachineTemplateSpec, s apiconversion.Scope) error {
	if err := autoConvert_v1alpha5_Metal3MachineTemplateSpec_To_v1alpha3_Metal3MachineTemplateSpec(in, out, s); err != nil {
		return err
	}
