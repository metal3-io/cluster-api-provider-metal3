...
BMO_OVERLAYS=(
  ...
  "${REPO_ROOT}/test/e2e/data/bmo-deployment/overlays/release-custom-image"
...
IRONIC_OVERLAYS=(
  ...
  "${REPO_ROOT}/test/e2e/data/ironic-deployment/overlays/release-custom-image"
...
update_kustomize_image quay.io/metal3-io/baremetal-operator BARE_METAL_OPERATOR_IMAGE "${REPO_ROOT}"/test/e2e/data/bmo-deployment/overlays/release-custom-image
update_kustomize_image quay.io/metal3-io/ironic IRONIC_IMAGE "${REPO_ROOT}"/test/e2e/data/ironic-deployment/overlays/release-custom-image
