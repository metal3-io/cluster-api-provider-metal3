...
case "${GINKGO_FOCUS:-}" in
  clusterctl-upgrade|k8s-upgrade|basic|integration|k8s-conformance|capi-md-tests)
    # if running basic, integration, k8s upgrade, clusterctl-upgrade, k8s conformance or capi-md tests, skip apply bmhs in dev-env
