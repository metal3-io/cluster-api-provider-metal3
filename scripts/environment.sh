...
export KUBERNETES_VERSION_UPGRADE_FROM=${KUBERNETES_VERSION_UPGRADE_FROM:-"v1.35.0"}
...
case "${GINKGO_FOCUS:-}" in
  ...
  k8s-upgrade-n3)
    ...
    export CONTROL_PLANE_MACHINE_COUNT=${CONTROL_PLANE_MACHINE_COUNT:-"3"}
    export WORKER_MACHINE_COUNT=${WORKER_MACHINE_COUNT:-"1"}
    export KUBERNETES_N0_VERSION=${KUBERNETES_N0_VERSION:-"v1.33.11"}
    export KUBERNETES_N1_VERSION=${KUBERNETES_N1_VERSION:-"v1.34.7"}
    export KUBERNETES_N2_VERSION=${KUBERNETES_N2_VERSION:-"v1.35.4"}
    export KUBERNETES_N3_VERSION=${KUBERNETES_N3_VERSION:-"v1.36.0"}
  ;;
