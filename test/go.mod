...
require (
	...
	github.com/metal3-io/baremetal-operator/apis v0.7.0
	github.com/metal3-io/baremetal-operator/test v0.7.0
	github.com/metal3-io/cluster-api-provider-metal3/api v1.5.1
