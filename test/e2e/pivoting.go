...
func pivoting(ctx context.Context, inputGetter func() PivotingInput) {
	...
	ironicDeploymentType := IronicDeploymentTypeKustomize
	if ephemeralCluster == Kind {
...
const (
	...
	IronicDeploymentTypeKustomize IronicDeploymentType = "kustomize"
...
func removeIronic(ctx context.Context, inputGetter func() RemoveIronicInput) {
	input := inputGetter()
	if input.DeploymentType == IronicDeploymentTypeKustomize {
