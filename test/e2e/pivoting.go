...
func pivoting(ctx context.Context, inputGetter func() PivotingInput) {
	...
	ironicKustomization := input.E2EConfig.MustGetVariable("IRONIC_RELEASE_CUSTOM_IMAGE")
	...
	bmoKustomization := input.E2EConfig.MustGetVariable("BMO_RELEASE_CUSTOM_IMAGE")
