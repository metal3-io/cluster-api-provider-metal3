...
func setReconcileNormalExpectations(ctrl *gomock.Controller,
	...
	if tc.BootstrapNotReady {
		m.EXPECT().SetConditionMetal3MachineToFalse(infrav1.AssociateBMHCondition,
			infrav1.WaitingForBootstrapReadyReason, clusterv1beta1.ConditionSeverityInfo, "")
	...
	if tc.Annotated {
		...
		if tc.Metal3DataClaimCreated {
			...
			m.EXPECT().SetV1beta2Condition(infrav1.KubernetesNodeReadyV1Beta2Condition,
...
func setReconcileDeleteExpectations(ctrl *gomock.Controller,
	...
	m.EXPECT().SetV1beta2Condition(infrav1.KubernetesNodeReadyV1Beta2Condition, metav1.ConditionFalse, infrav1.Metal3MachineDeletingV1Beta2Reason, "")
	...
	if tc.DeleteFails {
		...
		m.EXPECT().SetV1beta2Condition(infrav1.KubernetesNodeReadyV1Beta2Condition, metav1.ConditionFalse, infrav1.Metal3MachineDeletingFailedV1Beta2Reason, gomock.Any())
