	...
	DescribeTable("Reconcile tests",
		func(tc TestCaseReconcile) {
			...
			if tc.CheckBootStrapReady {
				...
				bootstrapReadyCondition := v1beta1conditions.Get(testmachine, clusterv1.BootstrapReadyV1Beta1Condition)
			...
			if tc.ClusterInfraReady {
				infrastructureReadyCondition := v1beta1conditions.Get(testcluster, clusterv1.InfrastructureReadyV1Beta1Condition)
