...
flowchart TB
    subgraph host["CI Host"]
        ...
        subgraph libvirt["libvirt world"]
            ...
            imgsrv["OS image server<br/>172.22.0.1:80"]
...
flowchart TB
    subgraph HOST["🖥️ CI Host (bare metal / VM) — Linux kernel networking + nftables"]
        ...
        subgraph DOCKER["🐳 Docker world"]
            ...
            KIND["kind node (container)<br/>Ironic · CAPM3 · BMO<br/>+ DHCP + IPA deploy images :6180"]
            KIND --- KB
        end
        ...
        subgraph LIBVIRT["🧬 libvirt world"]
            ...
            IMG["OS image server (container)<br/>172.22.0.1:80<br/>serves IMAGE_RAW_URL"]
...
flowchart LR
    ...
    I -->|"4 · DHCP + serve IPA deploy<br/>image :6180"| VM
