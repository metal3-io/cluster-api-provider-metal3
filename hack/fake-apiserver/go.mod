...
require (
	github.com/metal3-io/baremetal-operator/apis v0.11.3
	github.com/metal3-io/cluster-api-provider-metal3 v1.11.3
	github.com/metal3-io/cluster-api-provider-metal3/api v1.11.3
...
require (
	...
	github.com/metal3-io/ip-address-manager/api v1.11.3 // indirect
