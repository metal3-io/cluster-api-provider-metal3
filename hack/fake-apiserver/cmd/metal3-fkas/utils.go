...
func getPodNameByLabel(ctx context.Context, k8sClient client.Client, namespace string, labelSelector map[string]string) (string, error) {
	...
	return "", fmt.Errorf("Cannot find pod from namespace: %s", namespace)
}
